...
configure_odb() {
    # Execute Oracle DB configuration script
    echo "Configuring Oracle Database 19c..."
    /etc/init.d/oracledb_ORCLCDB-19c configure || die "Oracle DB configuration failed"
    echo "Oracle Database 19c configured successfully."
}
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
main() {
    configure_odb || die "Oracle DB configuration could not be completed"
}
